...
def targetMove():
    ...
    gameDisplay.blit(target , (mousePosition[0]-25 , mousePosition[1]-25) ) # positions carImg related to game display width & height
...
relood = soundFile('sound_effects/396331__nioczkus__1911-reload.aiff')
def sound(effect, volume=1, times=0):
...
def gameStart():
    ...
    while not gameExit:    # if crashed is false
        ...
        for d in range( len(menu_dimentions) ):
            if mousePosition[0] > menu_dimentions[d][0] and mousePosition[0]<menu_dimentions[d][0]+200 and mousePosition[1]>menu_dimentions[d][1] and mousePosition[1]< menu_dimentions[d][1] + displayHeight*.07:
        ...
        #display_message('HALL OF FAME', menu_dimentions[1] , 40 , menu_colors[1] )
...
def hall_of_fame():
    ...
    while not gameExit:
        ...
        clock.tick(10) # sets frames per second
#     import csv
#     with open('hall_of_fame.csv') as csv_file:
